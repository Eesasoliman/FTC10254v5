...
public class RedTruss extends DriveOpMode {
    ...
    public void runOpMode() {
        ...
        TrajectorySequence purple1 = drive.trajectorySequenceBuilder(startPose)
                ...
                .waitSeconds(0.5)
                .forward(12)
                .splineToLinearHeading(new Pose2d(-60,-23,Math.toRadians(0)),Math.toRadians(0))
                .UNSTABLE_addTemporalMarkerOffset(0,()-> intakeWhite1())
                .UNSTABLE_addTemporalMarkerOffset(.2,()-> intakeWhite2())
                .UNSTABLE_addTemporalMarkerOffset(.8,()-> robot.CLAW.setPosition(0.5))
                .UNSTABLE_addTemporalMarkerOffset(1.2,()-> intakeWhite4())
                .build();
        TrajectorySequence purple2 = drive.trajectorySequenceBuilder(startPose)
//                .strafeRight(4)
                .lineToConstantHeading(new Vector2d(-35.5, -34.5))
                .UNSTABLE_addTemporalMarkerOffset(0, () -> {
                    purpleIntake();
                })
                .waitSeconds(.7)
                .forward(8)
                .splineToLinearHeading(new Pose2d(-59,-26,Math.toRadians(0)),Math.toRadians(0))
                .UNSTABLE_addTemporalMarkerOffset(0,()-> intakeWhite1())
        ...
        TrajectorySequence purple3 = drive.trajectorySequenceBuilder(startPose)
                ...
                .waitSeconds(0.5)
                .forward(7)
                .splineToLinearHeading(new Pose2d(-60,-24,Math.toRadians(0)),Math.toRadians(0))
                .UNSTABLE_addTemporalMarkerOffset(0,()-> intakeWhite1())
